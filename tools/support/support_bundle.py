...
from clawos_core.constants import CLAWOS_CONFIG, CONFIG_DIR, HARDWARE_JSON, LOGS_DIR, SETUP_STATE_JSON, SUPPORT_DIR
...
def create_support_bundle() -> Path:
    ...
    with zipfile.ZipFile(bundle_path, "w", zipfile.ZIP_DEFLATED) as archive:
        ...
        for path in [CLAWOS_CONFIG, HARDWARE_JSON, SETUP_STATE_JSON]:
            if path.exists():
